...
public class ReservationDAO {
	...
	//커넥션풀(DataSource)을 얻은 후 ConnecionDB접속
		...
		public void addReserv(ReservationVO rm) {
			try {
				con = getConnection();
				String query = "INSERT INTO reservation(depplacename,arrplacename,reser_date,adultcharge,depplandtime,seat,reser_email,reser_id,count,traingradename) VALUES(?,?,now(),?,?,?,?,?,?,?)";
