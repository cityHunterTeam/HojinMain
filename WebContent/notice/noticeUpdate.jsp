...
<body>	
  <!--::header part start::-->
    ...
    <!-- Header part end-->
<!-- 로긴폼 -->
<c:set var="passwd" value="${vo.passwd }"/>
 	<div class="container" style="margin-top: 10px;">
		<div class="col-sm-12">						
			<form action="${contextPath }/not/noticeUpdatePro.do" method="post">	
			<input type="hidden" name="num" value="${vo.num }">																			
					...
					<table class="table">
						<tr>
							...
							<td><input type="text" class="form-control" readonly="readonly" name="id" value="${vo.id}">
							</td>
							</tr> 							
						<tr>
						<th  width="100px" style="padding: auto;"><h5>
